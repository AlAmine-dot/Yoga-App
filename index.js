...
const page = {
  ...
  routine: function () {
    ...
    utils.pageContent(
      ...
      "<button id='pause'>Pause<i class='far fa-play-circle'></i></button>"
    );
    pause.addEventListener("click", () => {
      if (pauses === false) {
        clearTimeout(play);
        pause.innerHTML = "Play <i class='far fa-play-circle'></i>";
        pauses = true;
      } else {
        exercice.updateCountdown();
        pause.innerHTML = "Pause <i class='far fa-play-circle'></i>";
        pauses = false;
      }
    });
  },
